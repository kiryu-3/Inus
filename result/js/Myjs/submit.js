...
function drawBar(perData){
    ...
    for (var idx = 1; idx < 67; idx++) {
        ...
        var layout = {
            barmode: 'stack',
            title: "<b>Q" + idx + "　<b>回答割合 (%)　n=" + allLatestData.length,
            legend: {
            orientation: 'h',
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener("click", function() {
        ...
        drawRadar(departmentPerData, departmentLengthData, "department");
        ...
        drawRadar(datePerData, dateLengthData, "date");
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener("click", function() {
        ...
        departmentPerData["your"] = [result1, result2, result3, result4];
        console.log("Your", departmentPerData);

        departmentLengthData["your"] = 1;
        
        drawRadar(departmentPerData, departmentPerData, "department");
